        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-zinc-400">
              Added on {new Date(domain.createdAt).toLocaleDateString()} · {domain.clicksRouted.toLocaleString()} clicks routed
            </p>
          </div>
        </div>
          ...
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-zinc-100 font-mono text-[11px] dark:divide-zinc-900">
              ...
              <tr>
                ...
                <td className="px-4 py-2.5">
                  <div className="flex items-center gap-2 text-zinc-900 dark:text-zinc-100">
                    ...
                    <button
                      type="button"
                      onClick={() => handleCopy('cname', domain.cnameTarget)}
              ...
              <tr>
                ...
                <td className="px-4 py-2.5 text-zinc-600 dark:text-zinc-400 truncate max-w-[120px]">
                  _flux-challenge
                </td>
                <td className="px-4 py-2.5">
                  <div className="flex items-center gap-2 text-zinc-900 dark:text-zinc-100">
                    <span className="truncate max-w-xs">{domain.txtVerificationValue}</span>
                    <button
                      type="button"
                      onClick={() =>
                        handleCopy('txt', domain.txtVerificationValue)
                      }
