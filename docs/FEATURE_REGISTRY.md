...
| FEAT-008 | Multi-Touch Attribution        | Attribution calculation (First/Last/Linear)           | WORKING   | 13    | `AttributionPage.tsx`    | `repository/clickhouse_attribution.go` | ClickHouse     | N/A   | Fully functional, real API & tracking connected.             |
...
| FEAT-010 | SaaS Billing (Stripe)          | Tier enforcement and billing portal                   | WORKING   | 14    | `BillingPage.tsx`        | `handler/billing.go`            | Postgres (`subscriptions`) | N/A   | Fully functional Stripe integration, DB enforcement, and UI. |
...
| FEAT-012 | Multi-Tenant Workspaces (RBAC) | Workspaces and role permissions                       | WORKING   | 12    | `WorkspacesPage.tsx`     | `middleware/clerk.go`             | Postgres (`workspaces`)    | N/A   | Fully functional with Clerk JWT mapping in middleware. |
