...
- [x] Sliders enforce total weight constraint of 100% with intuitive auto-balancing.
- [x] Real-time CTR comparisons highlight winning variants with statistical confidence tags (e.g. 95% confidence).
- [x] Lock Winner button immediately sets winner allocation to 100% and disables losing variants.
...
- [x] Step 1: Write weight calculation unit tests.
- [x] Step 2: Confirm test failure.
- [x] Step 3: Implement A/B testing page.
