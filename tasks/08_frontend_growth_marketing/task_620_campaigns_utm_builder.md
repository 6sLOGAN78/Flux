...
- [ ] Presets automatically populate `utm_source`, `utm_medium`, and `utm_campaign` based on selected channel.
- [ ] Real-time output preview shows the full sanitized URL and generated short code.
- [ ] Campaign table lists active campaigns, aggregate click counts, and conversion metrics.
...
- [ ] Step 1: Write UTM builder parameter serialization unit tests.
- [ ] Step 2: Confirm test failure.
- [ ] Step 3: Implement UTM Studio and Campaigns page.
