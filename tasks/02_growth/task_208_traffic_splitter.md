...
- [x] Splits traffic according to variant weights (e.g. 50/50, 80/20) with sticky visitor sessions.
...
- [x] **Step 2: Confirm test failure**: Run `go test -v ./internal/modules/abtest/...`.
- [x] **Step 3: Write minimal implementation** inside target files.
- [x] **Step 4: Confirm test passes**: Run `go test -v ./internal/modules/abtest/...`.
