...
- [x] Landing hero headline and value prop fit within initial desktop viewport with max 2 lines.
- [x] Interactive shortener simulates live Base62 encoding and displays instant preview without requiring login.
- [x] Pricing matrix features Free, Pro, and Enterprise tiers with Monthly/Annual discount toggle.
...
- [x] Step 1: Write page render unit tests.
- [x] Step 2: Confirm test failure.
- [x] Step 3: Implement Landing and Pricing pages.
