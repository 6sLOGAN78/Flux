...
- [x] Link Detail allows updating destination URL, title, description, and assigned category with live validation.
- [x] QR Code Studio provides real-time canvas preview of foreground/background colors and logo uploads with PNG/SVG export buttons.
- [x] Categories manager provides color-coded card grid, link count badges, and create/edit modal.
...
- [x] Step 1: Write unit tests for QR studio color sanitization and category mutations.
- [x] Step 2: Confirm test failure.
- [x] Step 3: Implement detail page and QR studio.
