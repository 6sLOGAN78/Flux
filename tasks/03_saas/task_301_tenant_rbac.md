...
- [x] Enforces strict data isolation between tenants and validates RBAC permissions.
...
- [x] **Step 2: Confirm test failure**: Run `go test -v ./internal/modules/tenant/...`.
- [x] **Step 3: Write minimal implementation** inside target files.
- [x] **Step 4: Confirm test passes**: Run `go test -v ./internal/modules/tenant/...`.
