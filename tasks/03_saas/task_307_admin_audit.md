...
- [x] Logs all administrative operations into immutable audit log tables.
...
- [x] **Step 2: Confirm test failure**: Run `go test -v ./internal/modules/audit/...`.
- [x] **Step 3: Write minimal implementation** inside target files.
- [x] **Step 4: Confirm test passes**: Run `go test -v ./internal/modules/audit/...`.
